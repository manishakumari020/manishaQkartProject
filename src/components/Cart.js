...
export const getTotalItems = (items = []) =>{
      ...
      const totalQut = items.map((item) => item.qty).reduce((total, n) => total + n);
      console.log(totalQut);
      return totalQut;
}
    ...
    <>
              ...
              <Box display="flex" alignItems="flex-start" padding="1rem">
                ...
                >
                  ...
                  <Box display="flex" justifyContent="space-between" alignItems="center"> 
                    ...
                    />
                    <Box padding="0.5rem" fontWeight="600">
                      ${item.cost}
                    </Box>
                  </Box>
                </Box>
      ...
      {isReadOnly && (
        <Box className="cart" padding="1rem">
          ...
          <Box className="cart-row" fontSize="1.2rem" fontWeight="600">
            <p>Total</p>
            <p>{getTotalCartValue(items)}</p>
          </Box>
        </Box>
